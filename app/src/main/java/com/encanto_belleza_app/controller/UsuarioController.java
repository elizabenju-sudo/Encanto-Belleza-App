...
public class UsuarioController {
    ...
    public Usuario obtenerUsuarioPorId(int id) {
        usuarioDAO.open();
        // Este método necesitaría ser implementado en UsuarioDAO
        // Por ahora retornamos null (se implementará si se necesita)
        usuarioDAO.close();
        return null;
    }

    // NUEVO MÉTODO: Obtener usuario actual
    public int obtenerIdUsuarioActual(String email) {
